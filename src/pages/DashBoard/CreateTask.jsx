...
const CreateTask = () => {
    ...
    const onSubmit = async(data) => {
        ...
        if (data) {
            ...
            const taskRes = await axiosPublic.post('/toDo', taskItem)
    ...
    return (
        <div>
            <h1 className="text-5xl text-center font-bold my-32 ">Create Your Task</h1>
            <div className="card  w-full max-w-6xl mx-auto  shadow-2xl bg-base-100 mb-32">
                <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                    <div className="form-control">
                        ...
                        <input type="text" {...register("title", { required: true })} name="title" placeholder="Enter Title" className="input input-bordered" required />
                    ...
                    <div className="form-control">
                        ...
                        <input type="date" {...register("deadline", { required: true })} name="deadline" placeholder="Enter task Deadline" className="input input-bordered" required />
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" {...register("description", { required: true })} name="description" placeholder="Enter task Description" className="input input-bordered" required />
